...
class Medician(models.Model):
    ...
    pharm_group = models.ForeignKey(Pharm_Group, on_delete=models.CASCADE,null=True, blank=True)
    kind = models.ForeignKey(Kind, on_delete=models.CASCADE,null=True, blank=True)
